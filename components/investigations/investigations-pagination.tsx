// components/investigations/investigations-pagination.tsx
'use client';

import Link from "next/link";

interface InvestigationsPaginationProps {
  currentPage: number;
  totalPages: number;
  hasNext: boolean;
  hasPrevious: boolean;
...
export default function InvestigationsPagination({
  currentPage,
  totalPages,
  hasNext,
  hasPrevious,
}: InvestigationsPaginationProps) {
